...
class User < ApplicationRecord
  ...
  has_many(:sent_follow_request, -> { where(:status => "accepted") }, class_name: "FollowRequest", foreign_key: "sender_id")
  ...
  has_many(:leaders, through: :sent_follow_requests, source: "User")
